...
&nbsp;<asp:TextBox ID="txtSelectMobile" runat="server" ForeColor="Maroon" MaxLength="11" ReadOnly="True"></asp:TextBox>
        ...
        <asp:SqlDataSource ID="SqlDataS1" runat="server" ConnectionString="<%$ ConnectionStrings:mikesConString1 %>" SelectCommand="SELECT * FROM [Customer] ORDER BY [Cust_ID]"></asp:SqlDataSource>
        <br />

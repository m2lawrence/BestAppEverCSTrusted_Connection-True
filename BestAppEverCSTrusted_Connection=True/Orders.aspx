...
&nbsp;<br />
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowSorting="True" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="275px" DataKeyNames="Order_ID" DataSourceID="SqlDataS1">
        ...
        <asp:SqlDataSource ID="SqlDataS1" runat="server" ConnectionString="<%$ ConnectionStrings:mikesConString1 %>" SelectCommand="SELECT * FROM [Orders] ORDER BY [Order_ID]"></asp:SqlDataSource>
        <br />
        ...
        <asp:DropDownList ID="DDLUpdateOrder_ID" runat="server" ForeColor="Maroon" DataSourceID="SqlDataS1" DataTextField="Order_ID" DataValueField="Order_ID" OnSelectedIndexChanged="DDLUpdateOrder_ID_SelectedIndexChanged">
            <asp:ListItem>1</asp:ListItem>
            <asp:ListItem>2</asp:ListItem>
            <asp:ListItem>3</asp:ListItem>
            <asp:ListItem>4</asp:ListItem>
...
&nbsp;Quantity<br />
        ...
        <asp:DropDownList ID="DDLOrder_ID" runat="server" ForeColor="Maroon" DataSourceID="SqlDataS1" DataTextField="Order_ID" DataValueField="Order_ID" OnSelectedIndexChanged="DDLOrder_ID_SelectedIndexChanged">

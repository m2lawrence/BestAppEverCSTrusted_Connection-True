...
&nbsp;<br />
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataS1" AllowSorting="True" DataKeyNames="Prod_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="624px">
        ...
        <asp:SqlDataSource ID="SqlDataS1" runat="server" ConnectionString="<%$ ConnectionStrings:mikesConString1 %>" SelectCommand="SELECT * FROM [Products] ORDER BY [Prod_ID]"></asp:SqlDataSource>
        <br />
...
&nbsp;Quantity<br />
        ...
        <br />
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataS1" AllowSorting="True" DataKeyNames="Prod_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="624px">
            <AlternatingRowStyle BackColor="PaleGoldenrod" />
            <Columns>
                <asp:BoundField DataField="Prod_ID" HeaderText="Prod_ID" ReadOnly="True" SortExpression="Prod_ID" />
                <asp:BoundField DataField="Cust_ID" HeaderText="Cust_ID" SortExpression="Cust_ID" />
        ...
        <br />
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataS1" AllowSorting="True" DataKeyNames="Prod_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="624px">
            <AlternatingRowStyle BackColor="PaleGoldenrod" />
            <Columns>
                <asp:BoundField DataField="Prod_ID" HeaderText="Prod_ID" ReadOnly="True" SortExpression="Prod_ID" />
                <asp:BoundField DataField="Cust_ID" HeaderText="Cust_ID" SortExpression="Cust_ID" />
